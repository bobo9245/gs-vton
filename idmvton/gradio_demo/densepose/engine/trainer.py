...
from idmvton.gradio_demo.detectron2.checkpoint import DetectionCheckpointer
from idmvton.gradio_demo.detectron2.config import CfgNode
from idmvton.gradio_demo.detectron2.engine import DefaultTrainer
from idmvton.gradio_demo.detectron2.evaluation import (
    DatasetEvaluator,
    DatasetEvaluators,
    inference_on_dataset,
    print_csv_format,
)
from idmvton.gradio_demo.detectron2.solver.build import get_default_optimizer_params, maybe_add_gradient_clipping
from idmvton.gradio_demo.detectron2.utils import comm
from idmvton.gradio_demo.detectron2.utils.events import EventWriter, get_event_storage

from idmvton.gradio_demo.densepose import DensePoseDatasetMapperTTA, DensePoseGeneralizedRCNNWithTTA, load_from_cfg
from idmvton.gradio_demo.densepose.data import (
    DatasetMapper,
...
from idmvton.gradio_demo.densepose.evaluation.d2_evaluator_adapter import Detectron2COCOEvaluatorAdapter
from idmvton.gradio_demo.densepose.evaluation.evaluator import DensePoseCOCOEvaluator, build_densepose_evaluator_storage
from idmvton.gradio_demo.densepose.modeling.cse import Embedder

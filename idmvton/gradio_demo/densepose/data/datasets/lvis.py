...
from idmvton.gradio_demo.detectron2.data import DatasetCatalog, MetadataCatalog
from idmvton.gradio_demo.detectron2.data.datasets.lvis import get_lvis_instances_meta

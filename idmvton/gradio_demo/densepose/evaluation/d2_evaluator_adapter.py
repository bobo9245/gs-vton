...
from idmvton.gradio_demo.detectron2.data.catalog import Metadata
from idmvton.gradio_demo.detectron2.evaluation import COCOEvaluator

from idmvton.gradio_demo.densepose.data.datasets.coco import (

...
from idmvton.gradio_demo.detectron2.data import MetadataCatalog
from idmvton.gradio_demo.detectron2.evaluation import DatasetEvaluator
from idmvton.gradio_demo.detectron2.structures import BoxMode
from idmvton.gradio_demo.detectron2.utils.comm import gather, get_rank, is_main_process, synchronize
from idmvton.gradio_demo.detectron2.utils.file_io import PathManager
from idmvton.gradio_demo.detectron2.utils.logger import create_small_table

from idmvton.gradio_demo.densepose.converters import ToChartResultConverter, ToMaskConverter
from idmvton.gradio_demo.densepose.data.datasets.coco import maybe_filter_and_map_categories_cocoapi
from idmvton.gradio_demo.densepose.structures import (

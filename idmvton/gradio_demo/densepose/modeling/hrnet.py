...
from idmvton.gradio_demo.detectron2.modeling.backbone import BACKBONE_REGISTRY
from idmvton.gradio_demo.detectron2.modeling.backbone.backbone import Backbone

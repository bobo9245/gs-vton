...
import gradio as gr
from idmvton.src.tryon_pipeline import StableDiffusionXLInpaintPipeline as TryonPipeline
from idmvton.src.unet_hacked_garmnet import UNet2DConditionModel as UNet2DConditionModel_ref
from idmvton.src.unet_hacked_tryon import UNet2DConditionModel
...
import numpy as np
from idmvton.gradio_demo.utils_mask import get_mask_location
from torchvision import transforms
import idmvton.gradio_demo.apply_net as apply_net
from idmvton.preprocess.humanparsing.run_parsing import Parsing
from idmvton.preprocess.openpose.run_openpose import OpenPose
from idmvton.gradio_demo.detectron2.data.detection_utils import convert_PIL_to_numpy,_apply_exif_orientation
...
def start_tryon(img,garm_img_front, garm_img_back,garment_des,is_checked,is_checked_crop,denoise_steps,seed):
    ...
    #아래 각 yaml 파일 경로 local로 설정함 환경 달라지면 재설정 필요!!
    args = apply_net.create_argument_parser().parse_args(('show', '/home/metown/Working/vton/GaussianEditor/idmvton/configs/densepose_rcnn_R_50_FPN_s1x.yaml', '/home/metown/Working/vton/GaussianEditor/idmvton/ckpt/densepose/model_final_162be9.pkl', 'dp_segm', '-v', '--opts', 'MODEL.DEVICE', 'cuda'))
